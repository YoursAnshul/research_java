...
public interface UserRepository extends JpaRepository<User, Short> {
	...
	@Query("SELECT NEW com.pro.api.models.business.UserMin(u.userid, u.dempoid, u.fname, u.lname, u.language, u.trainedon, u.status, u.canedit, u.preferredfname, u.preferredlname, u.role, u.buddy, u.empstatus, u.schedulinglevel) "
	...
	@Query("SELECT u FROM User u WHERE u.status = 1 ORDER BY u.fname, u.lname")
	List<User> findAllActiveUsersOrderedByName();

	@Query("SELECT u.userid FROM User u WHERE u.status = 1 ORDER BY u.userid")
