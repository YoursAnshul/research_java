...
@Component
public class Stage_1_Price_Claim_Download_Invoices {
	...
	@Autowired
	Stage_1_Price_Claim_Import_File importfile;
	...
	public void downloadInvoice(Page page, String vendorId) {
		...
		page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Review/Dispute Price Discrepancies")).click();
