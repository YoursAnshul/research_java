...
@Component
public class DimeTydStage3PageNewUi {
	...
	public ProcessStatus processPage(Page page, String po, String vendorId, String vendorName, Path downloadPath,
			...
			try {
				for (CSVRecord csvRecord : parser) {
					...
					StringBuilder sb = new StringBuilder(
							"INSERT IGNORE INTO CBMissingInvPODetails (vendorId,PO,ASIN,POASIN,Qty,unitCost,freightTerm,POInvoice,currency,invoiceDate,Ukey,ASINReceived,QtyReceived,createdDate,amountReceived,invoicedUnitCost) VALUES");
						...
						for (int row1 = 0; row1 < CbPoDetailsList.size(); row1++) {
							...
							if (vnderNameTrimed.startsWith("CA") || vnderNameTrimed.startsWith("US")) {
								sb.append("('" + vendorId + "','" + CbPoDetailsList.get(row1).getPo() + "','"
										...
										+ CbPoDetailsList.get(row1).getFreightTerm() + "','" + po + "','"
