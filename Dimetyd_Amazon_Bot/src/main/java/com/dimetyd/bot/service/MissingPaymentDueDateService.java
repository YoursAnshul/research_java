...
import com.dimetyd.bot.process.MissingDueDateUpdate;
...
@Service
public class MissingPaymentDueDateService {
	...
	@Autowired
	MissingDueDateUpdate missingDueDateUpdate;
	...
	public void startService() {
		...
		if (GlobalSession.getGlobalSession().getName().equals("missing_payment_due_date")) {

			logger.info("Missing Invoice_Shortage_Details Bot Started");
