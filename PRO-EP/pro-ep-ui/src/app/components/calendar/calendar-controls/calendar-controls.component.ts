...
export class CalendarControlsComponent implements OnInit {
  ...
  public setStartView(): void {
    ...
    switch (this._calendarType.toUpperCase()) {
      ...
      case 'WEEK': {
        this.startViewText = "month";
        //this.todayPickerLabel = 'Current Week';
        let currentWeek: IWeekStartAndEnd = Utils.setSelectedWeekStartAndEnd(currDate);
        this.todayPickerLabel = 'Current Week: ' + Utils.formatDateOnlyToString(currentWeek.weekStart, false, false) + ' – ' + Utils.formatDateOnlyToString(currentWeek.weekEnd, false, false);
        break;
      }
      case 'MONTH': {
        this.startViewText = "year";
        //this.todayPickerLabel = 'Current Month';
