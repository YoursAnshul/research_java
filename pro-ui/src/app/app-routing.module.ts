...
const routes: Routes = [
  ...
  { path: 'user-forecasting', component: UserCoreHoursComponent, canDeactivate: [UnsavedChangesGuard]},
  { path: 'project-forecasting', component: ProjectForecastingComponent, canDeactivate: [UnsavedChangesGuard]}
